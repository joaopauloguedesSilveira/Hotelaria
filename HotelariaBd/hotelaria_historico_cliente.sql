...
CREATE TABLE `historico_cliente` (
  ...
  `dia_cheg` varchar(45) NOT NULL,
  `dia_part` varchar(45) NOT NULL,
  `total_diaria` float NOT NULL,
  PRIMARY KEY (`id_hist`),
  KEY `Id_client_idx` (`id_cli`),
  KEY `Id_quarto_idx` (`id_quarto`),
  CONSTRAINT `Id_client` FOREIGN KEY (`id_cli`) REFERENCES `cliente` (`id`),
  CONSTRAINT `Id_quarto` FOREIGN KEY (`id_quarto`) REFERENCES `quartos` (`id_quart`)
...
-- Dump completed on 2019-03-22  8:29:39
