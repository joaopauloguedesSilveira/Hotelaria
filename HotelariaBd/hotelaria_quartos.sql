...
CREATE TABLE `quartos` (
  `id_quart` int(11) NOT NULL AUTO_INCREMENT,
  `vazio_quart` tinyint(4) NOT NULL,
  `tipo_quart` varchar(10) NOT NULL,
  `id_cli` int(11) NOT NULL,
  PRIMARY KEY (`id_quart`),
  KEY `id_cli_idx` (`id_cli`),
  CONSTRAINT `Id_Cliente` FOREIGN KEY (`id_cli`) REFERENCES `cliente` (`id`)
...
-- Dump completed on 2019-03-22  8:29:36
